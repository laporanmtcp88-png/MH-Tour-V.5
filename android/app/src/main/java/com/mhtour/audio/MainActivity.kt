...
class MainActivity : ComponentActivity() {
    // AUTO ONLINE: URL dapat ditanam saat build melalui Gradle property
    ...
    private fun normalizeHttpBaseUrl(value: String): String {
        ...
        require(v.startsWith("https://") || v.startsWith("http://")) { "Alamat server harus diawali http:// atau https://" }
        return v
    }
    ...
    private fun httpPost(path: String, body: JSONObject): JSONObject {
        val base = normalizeHttpBaseUrl(configuredServerUrl)
